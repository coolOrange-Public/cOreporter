...
namespace cOreport
{
    public class cOreport
    {
        ...
        public cOreport(string rdlcFile, DataTable table, System.Collections.Hashtable parameters )
        {
        ...
        public cOreport(string rdlcFile,DataTable[] tables, System.Collections.Hashtable parameters)
        {
        ...
        private void init(string rdlcFile, DataTable[] table, System.Collections.Hashtable parameters)
        {
            ...
            foreach (DictionaryEntry param in parameters) report.reportParameters.Add(param.Key.ToString(), param.Value.ToString());
